namespace HashKingsMiner
{
    ...
    using HashKingsMiner.Forms;
    using HashKingsMiner.Forms.Components;
    using HashKingsMiner.Interfaces;
    using HashKingsMiner.Miners;
    using HashKingsMiner.Utils;
    ...
    public partial class Form_Main : Form, Form_Loading.IAfterInitializationCaller, IMainFormRatesComunication
    {
        ...
        {
            InitializeComponent();
            Icon = HashKingsMiner.Properties.Resources.logo;
